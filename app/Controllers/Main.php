...
class Main extends BaseController
{
    ...
    public function save(){
        ...
        $post = [
            ...
            'elementary_level' => $this->request->getPost('elementary_level'),
            'school_address' => $this->request->getPost('school_address'),
            'year_attended' => $this->request->getPost('year_attended'),
            'secondary_level' => $this->request->getPost('secondary_level'),
            'school_location' => $this->request->getPost('school_location'),
            'year' => $this->request->getPost('year'),
            'college_level' => $this->request->getPost('college_level'),
